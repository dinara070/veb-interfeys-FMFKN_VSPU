...
SUBJECTS_LIST = [
    ...
    "Технології навчання фізики та інформатики", "Фізичні основи роботи біомедичної техніки",
    "Теоретична фізика. Статистична фізика і термодинаміка", "Теорія і практика підготовки з фізики до ЗНО (цикл 1)",
    "Фізика живих систем", "Теоретична фізика. Електронна теорія речовини", "Теорія і практика підготовки з фізики до ЗНО (цикл 2)",
    "Технології навчання фізики та астрономії", "Вибрані питання сучасної фізики, техніки, астрономії", 
    "Вибрані питання сучасної дидактики фізики", " Мобільні застосунки у навчанні фізики та астрономії", "Основи робототехніки",
    "Мобільні технології навчання предметів освітньої галузі «Природознавство»", "Технології захисту інформації",
    "Побудова та аналіз алгоритмів у шкільній інформатиці", " Диференціальні рівняння та рівняння математичної фізики",
    "Прикладна статистика, педагогічні вимірювання та моніторинг якості освіти", "Архітектура та програмне забезпечення комп'ютерних систем",
    "Методика виховної роботи", "Системи керування базами даних", "Теорія алгоритмів",
    "Методи оптимізації та дослідження операцій", "Управління навчальними проектами з інформатики та математики в ЗСО: вітчизняний та міжнародний виміри",
    "Управління проєктною діяльністю учнів з інформатики", "Інклюзивний медіапростір: європейський досвід",
    "Математичні методи у прийнятті рішень", "Спеціальна інформатика", "Історія педагогіки",
    "Системний аналіз та математичне моделювання освітніх процесів", "Наукові основи поглибленого навчання математики в профільній школі",
    "Машинне навчання в освіті", "Основи аналізу Фур’є", "Основи геометрії",
    "Основи теорії інтелектуальних систем", "Конструктивна геометрія", "Рівняння математичної фізики",
    "Комплексний аналіз", "Практика з програмування", "Основи теорії солітонів", "Тренінг розвитку стресостійкості"
    "Вікова фізіологія і основи медичних знань", "Права та свободи людини і громадянина",
    "Українська мова (за професійним спрямуванням)", "Безпека життєдіяльності та основи охорони праці", "Базова загальновійськова підготовка",
    "Польська мова: початковий курс", "Психологія лідерства", "Домедична допомога", "Вікова і педагогічна психологія",
