...
SUBJECTS_LIST = [
    ...
    "Математична логіка і теорія алгоритмів", "Пропедевтична практика", "Дистанційний супровід шкільного курсу математики",
    "Педагогічна практика в оздоровчих закладах (інструктивно-методична, позашкільна)", 
    "Інноваційний педагогічний досвід навчання математики (український та закордонний)", "Цифрові технології наукових досліджень",
    "Основи кібербезпеки", "Педагогічна практика з математики у закладах профільної середньої освіти",
    "Наукові основи поглибленого навчання математики", "Аналіз випадкових процесів і ланцюги Маркова"
]
