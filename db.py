...
def migrate_db():
    """Додає нові таблиці до існуючої бази без втрати даних."""
    conn = create_connection()
    c = conn.cursor()
    ...
    c.execute('''CREATE TABLE IF NOT EXISTS calendar_events
                 (id INTEGER PRIMARY KEY AUTOINCREMENT,
                  title TEXT, event_type TEXT, date TEXT, time TEXT,
                  description TEXT, group_name TEXT, created_by TEXT,
                  color TEXT DEFAULT "#1f77b4")''')

    # Архів відрахованих / випускників
    c.execute('''CREATE TABLE IF NOT EXISTS students_archive
                 (id INTEGER PRIMARY KEY AUTOINCREMENT,
                  full_name TEXT, group_name TEXT, reason TEXT,
                  order_number TEXT, archive_date TEXT, archived_by TEXT,
                  avg_grade REAL)''')
    ...
    c.execute('''CREATE TABLE IF NOT EXISTS email_log
                 (id INTEGER PRIMARY KEY AUTOINCREMENT,
                  ...
                  sent_by TEXT, sent_at TEXT, status TEXT)''')
