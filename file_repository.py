...
# ВАЖЛИВО: переконайтеся, що цей файл (db.py) існує у тій же папці
...
def file_repository_view():
    ...
    # Виклик функції підключення до БД
            ...
            with st.form("upload_form", clear_on_submit=True):
                ...
                if st.form_submit_button("Зберегти"):
                    if uploaded_file and f_desc:
                        ...
                        st.warning("Будь ласка, завантажте файл та додайте опис.")
    ...
    conn.close() # Закриваємо з'єднання після роботи
